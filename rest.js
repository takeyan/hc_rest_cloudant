...
// 負荷条件
var dashboardInfo = require("./cloudant.json");     // ダッシュボード情報
...
var credential = { user: args.user, password: args.password };  	// BASIC認証 userid,password
...
for (var i=0 ; i<dashboardInfo.length ; i++ ){
	dashboardClient[i] = new Client(credential);
